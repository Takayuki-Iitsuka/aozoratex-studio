...
[aozoratex.py](cci:7://file:///c:/Users/etsuk/PG/LaTex/aozoratex-studio/aozoratex.py:0:0-0:0) の `DEVICE_SIZES`（ハードコード定数）と [settings.ini](cci:7://file:///c:/Users/etsuk/PG/LaTex/aozoratex-studio/settings.ini:0:0-0:0) のセクション定義を合わせて整理すると、以下の通りです。
...
- [settings.ini](cci:7://file:///c:/Users/etsuk/PG/LaTex/aozoratex-studio/settings.ini:0:0-0:0) に `[PDF_<デバイス名>]` セクションを追加すれば、**カスタムデバイスも自由に追加可能**な設計です。
